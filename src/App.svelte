...
<div class="flex h-full items-center justify-center p-4">
  ...
  >
    <h1
      class="w-full border-b border-gray-300 bg-gray-200 py-2 text-center text-3xl font-bold text-blue-500"
    >
      To-Do Liste
    </h1>
    <div class="flex flex-col gap-2 p-2">
      ...
      {/if}
      <div class="flex flex-col gap-2 rounded-md bg-gray-100 p-2">
